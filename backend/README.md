...
## Project Structure
    ...
    ├── testapiautoteammemb_74038  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_74038`
...
2. Clone this repo and `cd testapiautoteammemb_74038`
